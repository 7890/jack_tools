...
- High quality resampling to match JACK sample rate (supports custom SR)
...
This document refers to 'jack_playfile' version 0.89.
...
Last Update: Sun Jan 10 20:19:26 CET 2016
